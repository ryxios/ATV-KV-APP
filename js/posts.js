...
$$('.berichte-preloader').hide()
  ...
  content: '<div class="popup">'+
            ...
            '<div class="page-content">'+
                '<div class="card card-post"><div class="posts-header align-items-flex-end no-padding no-margin" style="background-image:url('+ posts[id].jetpack_featured_media_url +')"><mark>'+ posts[id].title.rendered +'</mark></div></div>'+
